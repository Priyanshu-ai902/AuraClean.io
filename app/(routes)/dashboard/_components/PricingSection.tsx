...
function PricingSection() {
    return (
        <div>
            <DialogContent style={{ maxHeight: '500px' }} className='max-w-5xl'>

                <DialogHeader>
                    <DialogTitle>Upgrade Plan
                        <DialogDescription>
                            <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-2 lg:px-6">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
                                    ...
                                    <div className="rounded-2xl border pt-6border-gray-200 p-6 shadow-sm sm:px-8 lg:p-10">
                                        <div className="text-center">
                                            <h2 className="text-lg font-medium text-gray-900">
                                                Starter
                                                <span className="sr-only">Plan</span>
